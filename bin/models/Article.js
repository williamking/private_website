...
(function(){
  var mongoose, Comment, ObjectId, ArticleSchema, ArticleModel;
  ...
  ArticleModel.addComment = function(content, commentor, callback){
    ArticleModel.findOne({
      _id: id
    }, function(err, article){
      if (err) {
        ...
        if (article) {
          Comment.addComment(content, commentor, null, callback, function(err, comment){});
